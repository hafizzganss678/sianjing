...
console.log(color(figlet.textSync('Yadi x Hafiz', {
font: 'Standard',
...
function title() {
    console.log(color('','aqua'), color(`||========================================||`, "cyan"))
     console.log(color(' ||> ','cyan'), color(` Hallo Kak Hafiz `, 'cyan'))
     console.log(color(' ||> ','cyan'), color(`${time}`, 'cyan'))
     console.log(color(' ||> ','cyan'), color(`Script Ori Yadi x Hafiz`, 'cyan'))
     console.log(color('','aqua'), color(`||========================================||`, "cyan"))
}
...
const connectToWhatsApp = async () => {
    const conn = makeWASocket({
        ...
        auth: state,
        browser: ["Hafiz Whatsapp", "Browser", "3.0"]
    })
    title()
    store.bind(conn.ev)
